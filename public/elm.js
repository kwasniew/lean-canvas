		...
		_elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'uid',
					_1: _elm_lang$core$Json_Encode$int(model.uid)
				},
				_1: {
					ctor: '::',
					_0: {
												...
												return _elm_lang$core$Json_Encode$object(
													{
														...
														_0: {
															ctor: '_Tuple2',
															_0: 'section',
															_1: _elm_lang$core$Json_Encode$string(card.section)
														},
														_1: {
															ctor: '::',
															_0: {
															...
															_1: {
																...
																_1: {
																	...
																	_0: {
																		ctor: '_Tuple2',
																		_0: 'editing',
																		_1: _elm_lang$core$Json_Encode$bool(card.editing)
																	},
																	_1: {ctor: '[]'}
																}
															}
										...
										_1: _elm_lang$core$Json_Encode$object(
											{
												...
												_0: {
													ctor: '_Tuple2',
													_0: 'section',
													_1: _elm_lang$core$Json_Encode$string(model.entryCard.section)
												},
												_1: {
													ctor: '::',
													_0: {
														ctor: '_Tuple2',
														_0: 'text',
														_1: _elm_lang$core$Json_Encode$string(model.entryCard.text)
													},
													_1: {
														ctor: '::',
														_0: {
															ctor: '_Tuple2',
															_0: 'id',
															_1: _elm_lang$core$Json_Encode$int(model.entryCard.id)
														},
														_1: {ctor: '[]'}
													}
												}
	...
	function (entryCard, card) {
		return _elm_lang$core$Native_Utils.eq(card.editing, true) ? A2(
			_elm_lang$html$Html$textarea,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('edit-card-input'),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(entryCard.text),
										_1: {ctor: '[]'}
									}
								}
							}
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], className, ' section')),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-name', section),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('scrollable-items'),
							_1: {ctor: '[]'}
						},
						A2(
							_elm_lang$core$List$map,
							...
							A2(
								_elm_lang$core$List$filter,
								function (card) {
									return _elm_lang$core$Native_Utils.eq(card.section, section);
								},
								model.cards))),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('add-item'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Add a card...'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$core$Native_Utils.eq(model.editing, true) ? A2(
						...
						{ctor: '[]'}) : _elm_lang$html$Html$text(model.name),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('first-row'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(viewSectionWithModel, 'key-partners', 'first-row-column'),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$div,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('first-row-column'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(viewSectionWithModel, 'key-activities', 'first-row-column-row'),
											_1: {
												ctor: '::',
												_0: A2(viewSectionWithModel, 'key-resources', 'first-row-column-row'),
												_1: {ctor: '[]'}
											}
										}),
									_1: {
										ctor: '::',
										_0: A2(viewSectionWithModel, 'value-proposition', 'first-row-column'),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$div,
												...
												{
													ctor: '::',
													_0: A2(viewSectionWithModel, 'customer-relationships', 'first-row-column-row'),
													_1: {
														ctor: '::',
														_0: A2(viewSectionWithModel, 'channels', 'first-row-column-row'),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
												ctor: '::',
												_0: A2(viewSectionWithModel, 'customer-segments', 'first-row-column'),
												_1: {ctor: '[]'}
											}
										}
									}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('second-row'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(viewSectionWithModel, 'cost-structure', 'second-row-column'),
									_1: {
										ctor: '::',
										_0: A2(viewSectionWithModel, 'revenue-streams', 'second-row-column'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('new canvas'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
